...
$wbbgcolor5 = "#7AA1E6"; //color formularios
...
global $cuenta_tablas;  $cuenta_tablas++;
if ($cuenta_tablas==1) { $typ=1; } else { $typ=0; }
...
<table WIDTH=50% border=0 align=top cellpadding=1 cellspacing=0>
	<tr>
	<td width="100%" bgcolor="#D8D2BD" align="center">
	<table width="50%" height="100%" border="0" align="center" cellpadding="5" cellspacing="0" summary="" bgcolor="#F0EFE4">
		<tr>
		<td bgcolor="#F0EFE4"  width="100%" CLASS="content">
		<?php } elseif ($typ==1) { ?>
		<br><br><br>
		<table width="50%" border="0" align="top" cellpadding="0" cellspacing="0">
			...
			<table width="100%" height="100%" border="0" align="center" cellpadding="10" cellspacing="0" summary="" bgcolor="#FFFFFF">
				...
				<?php if (trozo($hiddenblocks,-1,"9")==0) {?>
					<img alt="[x]" title="Mostrar/Esconder contenido" id="pic9" src="../imagenes/minus.gif" onclick="blockswitch('9');" style="cursor: pointer;" align="right"><br>
					<div id="pe9" style="">
				<?php } else { ?>
					<img alt="[x]" title="Mostrar/Esconder contenido" id="pic9" src="../imagenes/plus.gif" onclick="blockswitch('9');" style="cursor: pointer;" align="right"><br>
...
global $hiddenblocks;
global $cuenta_tablas;  $cuenta_tablas--;
if ($cuenta_tablas==0) { $typ=1; } else { $typ=0; }
