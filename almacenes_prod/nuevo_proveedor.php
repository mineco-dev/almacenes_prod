...
{	
	...
	{	
		...
		$proveedor=utf8_decode(strtoupper($_REQUEST["txt_proveedor"]));	
      ...
      <tr align="center" bgcolor="#aeccf2" class="thead">
		...
		<?PHP
				...
				while($row=$fetch_array($result))
				{
					...
					{										
					echo '<tr class='.$clase.'>';								
					echo '<td>'.$row["nit"].'</td><td>'.utf8_encode($row["nombre"]).'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';					
					}
					else
					echo '<tr class='.$clase.'><td>'.$row["nit"].'</td><td>'.utf8_encode($row["nombre"]).'</td><td>'.$row["direccion"].'</td><td>'.$row["telefonos"].'</td><td><center><a href="editar_proveedor.php?id='.$row["rowid"].'"><img src="../images/iconos/ico_editar.jpg" alt="Modificar información"></a></center></td></tr>';										
					$i++;
				}
				$free_result($result);
			 ?>
